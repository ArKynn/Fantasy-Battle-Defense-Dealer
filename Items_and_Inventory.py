...
sword_lvl1 = weapon("Common Sword", 1, 0, 1, 1, recipe_sword_lvl1)
sword_lvl2 = weapon("Rare Sword", 2, 0, 2, 2, recipe_sword_lvl2) 
sword_lvl3 = weapon("Exotic Sword", 3, 0, 3, 3, recipe_sword_lvl3) 
sword_lvl4 = weapon("Legendary Sword", 4, 0, 4, 4, recipe_sword_lvl4)

hammer_lvl1 = weapon("Common Hammer", 1, 1, 0, 1, recipe_hammer_lvl1)
hammer_lvl2 = weapon("Rare Hammer", 2, 2, 0, 2, recipe_hammer_lvl2)
hammer_lvl3 = weapon("Exotic Hammer", 3, 3, 0, 3, recipe_hammer_lvl3)
hammer_lvl4 = weapon("Legendary Hammer", 4, 4, 0, 4, recipe_hammer_lvl4)

bow_lvl1 = weapon("Common Bow", 1, 1, 0, 1, recipe_bow_lvl1)
bow_lvl2 = weapon("Rare Bow", 2, 2, 0, 2, recipe_bow_lvl2)
bow_lvl3 = weapon("Exotic Bow", 3, 3, 0, 3, recipe_bow_lvl3)
bow_lvl4 = weapon("Legendary Bow", 4, 4, 0, 4, recipe_bow_lvl4)

helmet_lvl1 = armor("Common Helmet", 1, 1, 0, 1, recipe_helmet_lvl1)
helmet_lvl2 = armor("Rare Helmet", 2, 2, 0, 2, recipe_helmet_lvl2)
helmet_lvl3 = armor("Exotic Helmet", 3, 3, 0, 3, recipe_helmet_lvl3)
helmet_lvl4 = armor("Legendary Helmet", 4, 4, 0, 4, recipe_helmet_lvl4)

chestplate_lvl1 = armor("Common Chestplate", 1, 1, 0, 1, recipe_chestplate_lvl1)
chestplate_lvl2 = armor("Rare Chestplate", 2, 2, 0, 2, recipe_chestplate_lvl2)
chestplate_lvl3 = armor("Exotic Chestplate", 3, 3, 0, 3, recipe_chestplate_lvl3)
chestplate_lvl4 = armor("Legendary Chestplate", 4, 4, 0, 4, recipe_chestplate_lvl4)

greaves_lvl1 = armor("Common Greaves", 1, 1, 0, 1, recipe_greaves_lvl1)
greaves_lvl2 = armor("Rare Greaves", 2, 2, 0, 2, recipe_greaves_lvl2)
greaves_lvl3 = armor("Exotic Greaves", 3, 3, 0, 3, recipe_greaves_lvl3)
